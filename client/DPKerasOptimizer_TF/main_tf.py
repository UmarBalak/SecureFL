...
from model_tf import IoTModel
from training_tf import IoTModelTrainer
...
if PATH_MODE == "colab":
    ...
    SAVE_DIR = "/content/drive/MyDrive/SecureFL/mlp_models_for_ae_tf"
else:
...
def main(client_id, epochs, X_train, X_test, y_train, y_test, y_type, num_classes, l):
    ...
    model.summary()
    model.save(os.path.join(SAVE_DIR, f"weights.h5"))
...
#         model_dir = "/content/drive/MyDrive/SecureFL/mlp_models_for_ae_tf"
